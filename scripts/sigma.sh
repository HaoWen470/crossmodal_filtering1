...
--experiment_name fusion_sigma_many_loss --pretrain 10 \
--load_checkpoint checkpoints/fusion_poe_1000_hu64_1loss-phase_3_e2e.ckpt \
--lr 1e-5 --train fusion --many_loss 

python train_fusion.py --data_size 1000 --batch 128 --epochs 5 --fusion_type sigma \
--experiment_name fusion_sigma_final_1 --pretrain 5 \
...
# --experiment_name fusion_sigma_truncated_0 --pretrain 5 \
